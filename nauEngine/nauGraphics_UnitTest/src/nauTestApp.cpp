...
namespace nauEngineSDK {
  ...
  TestApp::initApp(void* hwnd) {
    ...
    pPlateTexture->loadFromFile("resources/Vela/Vela_Gun_BaseColor.tga", m_api->getDevice());
    mat5->setMaterial(pPlateTexture, MATERIAL_FLAG::BASECOLOR);
    pPlateTexture->loadFromFile("resources/Vela/Vela_Gun_Metallic.tga", m_api->getDevice());
    mat5->setMaterial(pPlateTexture, MATERIAL_FLAG::METAL);
    pPlateTexture->loadFromFile("resources/Vela/Vela_Gun_Normal.tga", m_api->getDevice());
    mat5->setMaterial(pPlateTexture, MATERIAL_FLAG::NORMAL);
    pPlateTexture->loadFromFile("resources/Vela/Vela_Gun_Roughness.tga", m_api->getDevice());
    ...
    pEyesTexture->loadFromFile("resources/Vela/Vela_Gun_BaseColor.tga", m_api->getDevice());
    mat6->setMaterial(pEyesTexture, MATERIAL_FLAG::BASECOLOR);
    pEyesTexture->loadFromFile("resources/Vela/Vela_Gun_Metallic.tga", m_api->getDevice());
    mat6->setMaterial(pEyesTexture, MATERIAL_FLAG::METAL);
    pEyesTexture->loadFromFile("resources/Vela/Vela_Gun_Normal.tga", m_api->getDevice());
    mat6->setMaterial(pEyesTexture, MATERIAL_FLAG::NORMAL);
    pEyesTexture->loadFromFile("resources/Vela/Vela_Gun_Roughness.tga", m_api->getDevice());
